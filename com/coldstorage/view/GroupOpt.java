...
public class GroupOpt extends BaseClass implements ActionListener 
{
	...
	public  GroupOpt(String nm,String repNm)
	{
				...
				if (key == KeyEvent.VK_ENTER) {
					...
					case 1: 
						...
						if(isValidDate(date))
						{
							...
							{
								JOptionPane.showMessageDialog(GroupOpt.this,"Date range should be in between: "
...
//		smonth.addActionListener(this);
		...
		productCombo = new JComboBox(groupNames);
		productCombo.setBounds(103, 209, 269, 22);
		productCombo.setFont(fontHindi);
...
//				 MonthDto sdt = (MonthDto) smonth.getSelectedItem(); 
				 ...
				 Integer code = productCombo.isEnabled()?((GroupDto)productCombo.getSelectedItem()).getGp_code():0;
