...
public class GroupMaster extends BaseClass implements ActionListener 
{
...
*/		
		lblDispatchEntry = new JLabel("Group Master");
		...
		String [] partyColName=	{"Code.", "Group Name",""};
		String datax[][]={{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}};
...
*/
		...
		addKeyListener(GroupMaster.this,keyListener);
		
		setFocusListener(GroupMaster.this);
 ...
 //						panel_2.setBackground(SystemColor.activeCaptionBorder);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getActionCommand().equalsIgnoreCase("Add"))
		{
			...
			lastno=prddao.lastGpcode(loginDt.getDepo_code(),loginDt.getDiv_code());
	...
	public void saveData()
	{
		...
		if(option.equals("1"))
		{
			if(pname.getText().length()>0)
				i=prddao.addGroup(saveProduct());
			if(i>0)
				alertMessage(GroupMaster.this, "Record Added Successfully. Group Code is "+i,"Group Master",1);
			else
				alertMessage(GroupMaster.this, "Error While Saving!!!","Group Master",2);
		...
		if(option.equals("2"))
		{
			i =prddao.updateGroup(saveProduct());
			if(i>0)
				alertMessage(GroupMaster.this, "Record Updated Successfully. ","Group Master",1);
			else
				alertMessage(GroupMaster.this, "Error While Saving!!!","Group Master",2);
...
//		loginDt.setPrdlist(prddao.getPrdList(loginDt.getDiv_code(),loginDt.getDepo_code(),0));
	...
	public void fillData(GroupDto g)
	{
		...
		pcode.setEditable(false);
		setCaretPositionTextField(GroupMaster.this);
		adddata=true;
		option="2";
	...
	public GroupDto saveProduct() {
		...
		g.setDiv_code(loginDt.getDiv_code());	
	...
	public void fillInvTable()
	{
		...
		Vector data = (Vector) prddao.getGroupDetail(loginDt.getDepo_code(),loginDt.getDiv_code());
