...
public class PrtOpt extends BaseClass implements ActionListener 
{
	...
	public  PrtOpt(String nm,String repNm)
	{
				...
				if (key == KeyEvent.VK_ENTER) {
					...
					case 1: 
						...
						if(isValidDate(date))
						{
							...
							{
								JOptionPane.showMessageDialog(PrtOpt.this,"Date range should be in between: "
...
//		panel_1.setBorder(new LineBorder(new Color(0, 0, 0)));
	...
	public void fillItemDataPrd(boolean res)
	{
		...
		int groupCode=0;
		Vector prtVec =null;
		prtVec = (Vector) productNames;
		int size= prtVec.size();
		Vector dd = null;
		for(int i =0;i<size;i++)
		{
			prt = (ProductDto) prtVec.get(i);
				dd = new Vector();
