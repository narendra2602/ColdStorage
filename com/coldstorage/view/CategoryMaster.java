...
public class CategoryMaster extends BaseClass implements ActionListener 
{
...
*/		
		lblDispatchEntry = new JLabel("Category Master");
		...
		String [] partyColName=	{"Code.", "Category Name",""};
		String datax[][]={{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}};
...
*/
		...
		lblProductCode = new JLabel("Category Code:");
		lblProductCode.setBounds(291, 190, 140, 20);
		getContentPane().add(lblProductCode);
		
		lblProductName = new JLabel("Category Name:");
		lblProductName.setBounds(291, 220, 140, 20);
		getContentPane().add(lblProductName);

		lblshortname = new JLabel("Category Name Hindi:");
		...
		addKeyListener(CategoryMaster.this,keyListener);
		
		setFocusListener(CategoryMaster.this);
	...
	public void saveData()
	{
		...
		if(option.equals("1"))
		{
			if(pname.getText().length()>0)
				i=prddao.addCategory(saveProduct());
			if(i>0)
				alertMessage(CategoryMaster.this, "Record Added Successfully. Category Code is "+i,"Category Master",1);
			else
				alertMessage(CategoryMaster.this, "Error While Saving!!!","Category Master",2);
		...
		if(option.equals("2"))
		{
			i =prddao.updateCategory(saveProduct());
			if(i>0)
				alertMessage(CategoryMaster.this, "Record Updated Successfully. ","Category Master",1);
			else
				alertMessage(CategoryMaster.this, "Error While Saving!!!","Category Master",2);
...
//		loginDt.setPrdlist(prddao.getPrdList(loginDt.getDiv_code(),loginDt.getDepo_code(),0));
	...
	public void fillData(GroupDto g)
	{
		...
		setCaretPositionTextField(CategoryMaster.this);
		adddata=true;
		option="2";
	...
	public void fillInvTable()
	{
		...
		Vector data = (Vector) prddao.getCategoryDetail(loginDt.getDepo_code());
	...
	{
		fillInvTable();
		lastno=prddao.lastCategorycode(loginDt.getDepo_code());
		prd_name.requestFocus();
		super.setVisible(b);
	}
