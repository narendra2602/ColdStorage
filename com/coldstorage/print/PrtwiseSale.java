...
public class PrtwiseSale  extends WriteExcel
{    
   /**   
	 * 
	 */
   ...
   public PrtwiseSale(Integer year,Integer depo,Integer div, String sdate ,String edate ,String btnnm,String drvnm,String printernm,String brnm,Integer code,ArrayList prdList,Integer doc_tp) 
   ...
   { 
    try {
    	...
    	wtxt="PartyWiseItemWise";
    	filename="PartyWiseItemWiseInward-"+sdf2.format(new Date());
    	if(this.div==99)
    	{
        	filename="PartyWiseGroupInward-"+sdf2.format(new Date());
        	wtxt="PartyWiseGroupwise";
   ...
   public void order() {
    ...
    try {
		   ...
		   salreg =   (ArrayList<?>) srg.prtwiseSale(year,depo,div,stdt,eddt,doc_tp,code,prdList);
...
public void createHeader(WritableSheet sheet)
	   ...
	   if(div==99)
		   addCaption1(sheet, 0, 1, "Partywise GroupWise Inward  from "+sdate+" - "+edate,30);
	   else
		   addCaption1(sheet, 0, 1, "Partywise ItemWise Inward  from "+sdate+" - "+edate,30);
