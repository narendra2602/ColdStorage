...
public class GenerateGatePass extends WritePDF
{
	...
	public GenerateGatePass (String year,String depo,String div,String sinv,String einv,String btnnm,String drvnm,String printernm,String optn,Integer mncode,Integer doc_tp,String brnnm,String divnm,OutputStream emailPdfStream,Integer bunch)	
	{
...
//		drvnm="c:\\Report";
		...
		try {
			...
			cb.lineTo(590,270);
 			...
 			cb.moveTo(20,170);  // horizontal lines at the bottom
			cb.lineTo(590,170);
			...
			cb.lineTo(590,680);
 			...
 			cb.moveTo(20,580);  // horizontal lines at the bottom
			cb.lineTo(590,580);
